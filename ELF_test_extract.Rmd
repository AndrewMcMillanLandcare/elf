...
rect = data.frame(X = c(v1_x, v2_x, v4_x, v3_x, v1_x), Y = -1*(c(v1_y, v2_y, v4_y, v3_y, v1_y))) %>% 
...
XYZ_flat = XY_flat %>% dplyr::select(X = X_flat, Y = Y_flat, Z = Z)
