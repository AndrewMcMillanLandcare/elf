...
merge_elf_layers = function(LA_INPUT, LB_INPUT, datadir,  ffn_stub_list, ncore_rec = 36){
  ...
  LAxLB = ea_intersection(LB, LA_overlaps,PC = Current_PC, ffn_stub = ffn_stub_list[1], dn = datadir, parallel = T, ncore = ncore_rec, val = "both",diff_opt = F )
  ...
  LA_minus_LAxLB = ea_intersection(LB, LBxLA_unn,PC = Current_PC, ffn_stub = ffn_stub_list[2], dn = datadir, parallel = T, ncore = ncore_rec, val = "P1",filetype = "SHP",diff_opt = T )
  ...
  LB_minus_LAxLB = ea_intersection(LB, LBxLA_unn,PC = Current_PC, ffn_stub = ffn_stub_list[3], dn = datadir, parallel = T, ncore = ncore_rec, val = "P1",filetype = "SHP",diff_opt = T )
  ...
  OUT = list(LAxLB, LA_minus_LAxLB, LB_minus_LAxLB)
}
...
L0xL1 = merge_elf_layers(L0,L1, datadir = elf_merge_dn, ffn_stub_list = ffn_stub_list,ncore_rec = 36) #551 seconds
