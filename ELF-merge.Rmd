...
```{r}
  ...
  MERGE_L1_L2_RES = merge_elf_layers(LA_INPUT, LB_INPUT, LB_LIM_FIELDNAME, LB_LIMITATION_descr, elf_merge_dir,  ffn_stub_list, ncore_rec = 24)
...
# MERGE_L4_L5 : SALINE (L5) ---> L2_L3_MERGED 

```{r}
#Merge TOO_WET into L1_L2_MERGED to create the merged layer "L1_L2_MERGED"
  
  ffn_stub_list = c("L4xL5", "L4_minus_L4xL5", "L5_minus_L4xL5", "L4_L5_MERGED")
  LA_INPUT = st_read(paste0(elf_merge_dir, "L4_L5_MERGED.gpkg"))
