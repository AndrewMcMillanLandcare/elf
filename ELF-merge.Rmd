...
```{r}
  ...
  MERGE_L1_L2_RES = merge_elf_layers(LA_INPUT, LB_INPUT, LB_LIM_FIELDNAME, LB_LIMITATION_descr, elf_merge_dir,  ffn_stub_list, ncore_rec = 48)
...
#Merge TOO_DRY into L2_L3_MERGED to create the merged layer "L3_L4_MERGED"
  ...
  LB_INPUT = st_read(paste0(elfdir,"DATA/SOIL_Limitation_layers/finished_unmerged_layers/LIMITING_SOILS_TOO_DRY.shp"))
  # mapview(LB_INPUT)
  LB_LIM_FIELDNAME = "WET"
  LB_LIMITATION_descr = "Too Wet"
